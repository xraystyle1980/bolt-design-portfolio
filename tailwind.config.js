  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-xl': ['48px', { lineHeight: '100%', letterSpacing: '-0.48px', fontWeight: '400' }],
        'display-lg': ['36px', { lineHeight: '100%', letterSpacing: '-0.36px', fontWeight: '400' }],
        'display-md': ['30px', { lineHeight: '100%', fontWeight: '400' }],
        'display-sm': ['24px', { lineHeight: '100%', fontWeight: '400' }],
        'display-xs': ['20px', { lineHeight: '100%', fontWeight: '400' }],
        'display-xxs': ['16px', { lineHeight: '100%', fontWeight: '400' }],
        // Body scale
