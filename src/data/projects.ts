...
export const projects: Project[] = [
  {
    ...
    solution: 'We developed a cutting-edge mobile application that combines social features, personalized content, and real-time engagement. The app uses machine learning to customize content delivery and AI-driven insights to enhance user experience.',
    sections: [
      {
        title: 'User-Centric Design Process',
        content: 'Through extensive user research and iterative design sprints, we identified key pain points in existing sports apps. This led to the development of innovative features like personalized highlight reels and social prediction games.',
        image: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&q=80&w=2000'
      },
      {
        title: 'Technical Innovation',
        content: 'The app leverages React Native for cross-platform compatibility, real-time data processing with Firebase, and machine learning models for content personalization. This technical stack ensures smooth performance and scalability.',
        image: 'https://images.unsplash.com/photo-1556761175-129418cb2dfe?auto=format&fit=crop&q=80&w=2000'
      },
      {
        title: 'Impact & Results',
        content: 'Within six months of launch, the app achieved over 500,000 downloads and maintained a 4.8/5 star rating. User engagement metrics showed a 300% increase compared to industry standards.',
        image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&q=80&w=2000'
      }
    ],
    technologies: ['React Native', 'TypeScript', 'Node.js', 'Firebase', 'TensorFlow'],
    testimonial: {
      quote: 'The Decent App has transformed how our users interact with sports content. It is not just an app, it is a community.',
      author: 'Sarah Chen',
      role: 'Product Director, Decent Sports Inc.'
    }
  },
  {
    id: 'blockset-docs',
