...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-3 rounded-[100px] font-domine font-normal transition-[transform,colors,background-color,border-color] duration-200 ease-custom-spring hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
