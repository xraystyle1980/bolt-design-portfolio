    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 relative">
        ...
        <div className="relative pt-48 px-8 md:px-16 lg:px-24 text-white">
          <Link to="/" className="inline-flex items-center text-sm hover:text-neutral-200 mb-8">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Home
          </Link>
          <p className="text-xl mb-4">{project.category}</p>
      ...
      <section className="px-8 md:px-16 lg:px-24 py-24">
        ...
        <div className="my-32 text-center max-w-3xl mx-auto">
          ...
          <cite className="not-italic">
            ...
            <p className="text-neutral-600">{project.testimonial.role}</p>
          </cite>
        </div>
